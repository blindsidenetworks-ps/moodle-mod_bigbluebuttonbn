...
$string['view_noguests'] = 'Le BigBlueButtonBN n\'est pas ouvert aux visiteurs';
$string['view_nojoin'] = 'Vous n\'êtes pas dans un rôle autorisés à adhérer à la présente session.';
