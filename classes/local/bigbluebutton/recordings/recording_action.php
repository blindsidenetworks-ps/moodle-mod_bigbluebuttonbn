...
class recording_action {
     ...
     */
    public static function action_import($params, $recordings) {
     ...
     * @return array
     */
    public static function action_delete($params, $recordings) {
     ...
     * @return array
     */
    public static function action_edit($params, $recordings) {
        if ($recordings[$params['id']]->imported) {
     ...
     * @return array
     */
    public static function action_unprotect($params, $recordings) {
        if ($recordings[$params['id']]->imported) {
     ...
     * @return array
     */
    public static function action_protect($params, $recordings) {
        if ($recordings[$params['id']]->imported) {
            /* Since the recording link is the one fetched from the BBB server, imported recordings can not be
     ...
     * @return array
     */
    public static function action_unpublish($params, $recordings) {
        if ($recordings[$params['id']]->imported) {
            /* Since the recording link is the one fetched from the BBB server, imported recordings can not be
     ...
     * @return array
     */
    public static function action_publish($params, $recordings) {
        if ($recordings[$params['id']]->imported) {
            /* Since the recording link is the one fetched from the BBB server, imported recordings can not be
             * unpublished. There is no need to do anything else.
             */
