...
class config {
    ...
    public static function defaultvalues() {
        return array(
            ...
            'guestlink_moderatormessage_default' => false,
            'guestlink_moderatormessage_editable' => true,
    ...
    public static function get_options() {
        return array(
               ...
               'guestlink_moderatormessage_default' => self::get('guestlink_moderatormessage_default'),
               'guestlink_moderatormessage_editable' => self::get('guestlink_moderatormessage_editable'),
