    ...
    $instanceprofiles = array(
        ...
        BIGBLUEBUTTONBN_TYPE_ROOM_ONLY => array('id' => BIGBLUEBUTTONBN_TYPE_ROOM_ONLY,
            ...
            'features' => array('showroom', 'welcomemessage', 'voicebridge', 'waitformoderator', 'userlimit',
                ...
                'clienttype', 'completionattendance', 'completionengagement', 'availabilityconditionsheader', 'guestlink')),
...
function bigbluebuttonbn_get_enabled_features($typeprofiles, $type = null) {
    ...
    $enabledfeatures['guestlink'] = false;
    if (\mod_bigbluebuttonbn\locallib\config::guestlink_enabled()) {
        $enabledfeatures['guestlink'] = (in_array('all', $features) || in_array('guestlink', $features));
    }
