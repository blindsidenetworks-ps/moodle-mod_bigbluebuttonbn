...
M.mod_bigbluebuttonbn.custom = {
                                        ...
                                        <tbody>
                                            <tr data-index="1">
                                                <td data-name="server_name">
                                                    <input type="text" name="server_name"  placeholder="Server Name" class="form-control" onkeypress="return M.mod_bigbluebuttonbn.custom.validationAN(event);"/>
                                                </td>
  ...
  addServer: function () {
    let parentTable = document
      .getElementById("tab_logic")
    ...
    for (let i = 0; i < 3; i++) {
      ...
      //indica la position del input en este caso siempre el primer input
      if(i==0){
      ...
      if (i == 2) {
        ...
        mybutton.setAttribute(
          "onclick",
          "M.mod_bigbluebuttonbn.custom.deleteRow(this)"
        );
