<?php
/**
 * Language Converter for French, Français (fr)
 *
 * Authors:
...
$string["bbbduetimeoverstartingtim"] = "La date de fin doit être supérieure à la date de début.";
...
$string["bbbnorecordings"] = "Il n'y a pas d'enregistrement actuallement. Merci de revenir plus tard.";
...
$string["bigbluebuttonbn:moderat"] = "Modérer une conférence";
...
$string["index_heading_nam"] = "Salon";
...
$string["mod_form_block_schedul"] = "Planification de session";
$string["mod_form_field_availabledat"] = "Connexion à partir de";
$string["mod_form_field_description"] = "Description de la session enregistrée";
$string["mod_form_field_duedat"] = "Connexion jusqu'à";
...
$string["mod_form_field_nam"] = "Nom de la conférence";
...
$string["mod_form_field_voicebridg"] = "Connexion orale";
...
$string["mod_form_field_welcom"] = "Message d'accueil";
$string["modulenam"] = "BigBlueButtonBn";
$string["modulenameplural"] = "BigBlueButtonBn";
$string["pluginadministration"] = "Administration BigBlueButton";
$string["pluginnam"] = "BigBlueButtonBn";
...
$string["view_recording_list_actionbar_delet"] = "Supprimer";
$string["view_recording_list_actionbar_hid"] = "Cacher";
...
$string["view_recording_list_cours"] = "Cours";
$string["view_recording_list_dat"] = "Date";
