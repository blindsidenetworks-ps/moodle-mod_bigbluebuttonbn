...
$bigbluebuttonbn_locales = Array(
        ...
        'view_error_no_group_student'=> "Vous n\'avez pas été inscrit dans un groupe. Veuillez contacter votre enseignant, ou l\'administrateur.",
        'view_error_no_group_teacher'=> "Il n\'y a pas de groupe configuré actuellement. Veuillez créer des groupes, ou contacter l\'administrateur.",
        'view_error_no_group'=> "Il n\'y a pas de groupe configuré actuellement. Veuillez créer des groupes avant d\'essayer de vous connecter à la conférence.",
