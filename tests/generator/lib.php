...
class mod_bigbluebuttonbn_generator extends \testing_module_generator {
     ...
     * @param $bbactivity
     * @param $recordingname
     * @param bool $playbacknotes has playback notes
     * @param bool $playbackpresentation has playback presentation
     * @param int $recordingtime duration of the recording
     * @param string $remotehost remotehost name
     * @param array $othervalues record field to take values from (an array)
