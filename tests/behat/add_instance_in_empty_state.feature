@mod @mod_bigbluebuttonbn @with_default_bbb_server @javascript
Feature: I can create a bigbluebuttonbn instance with default server
  ...
  Scenario Outline: Users should see a notification message when accessing activities if the default server is used
    ...
    Examples:
      ...
      | user1      | To use BigBlueButton, your site will soon require new server credentials. Please contact your site administrator for help with this.| should not see |
      | teacher1   | To use BigBlueButton, your site will soon require new server credentials. Please contact your site administrator for help with this.| should see |
      | admin      | Default BigBlueButtonBN plugin credentials will soon be invalid. To continue using this plugin, please register through the Blindside Networks Registration Portal| should see |
