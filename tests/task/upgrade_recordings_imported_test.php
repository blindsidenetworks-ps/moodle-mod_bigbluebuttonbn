 ...
 * @covers \mod_bigbluebuttonbn\task\upgrade_imported_recordings
...
class upgrade_recordings_imported_test extends advanced_testcase {
    ...
    public function test_upgrade_recordings(): void {
        ...
        $this->assertEquals(0, $DB->count_records('bigbluebuttonbn_logs', ['log' => 'Import']));
        $this->assertEquals(75, recording::count_records(['imported' => '1']));

        $this->assertEquals(15, recording::count_records(['groupid' => $groupa->id, 'imported' => '1']));
        $this->assertEquals(15, recording::count_records(['groupid' => $groupb->id, 'imported' => '1']));
        $this->assertEquals(45, recording::count_records(['groupid' => 0, 'imported' => '1']));
