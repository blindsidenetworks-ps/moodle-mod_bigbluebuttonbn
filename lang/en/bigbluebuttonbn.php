...
$string['mod_form_block_participants'] = 'User/Role Mapping to Join the Meeting';
...
$string['mod_form_field_participant_add'] = 'Add mapping';
$string['mod_form_field_participant_list'] = 'Mapping list';
