...
$string['view_recording_publish_link_deleted'] = 'This link can not be re-published because the actual recording does not exit in the current BigBlueButton server. The link should be removed.';
