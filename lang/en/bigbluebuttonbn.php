...
$string['config_feature_newwindow'] = 'Configuration for "Open in a new window" feature';
$string['config_feature_newwindow_description'] = 'These settings are feature specific';
...
$string['config_feature_newwindow_editable'] = 'Open in a new window feature can be edited';
$string['config_feature_newwindow_editable_description'] = 'Open in a new window value by default can be edited when the room or conference is added or updated.';
