...
$string['bigbluebuttonbn:guestlink_view'] = 'See the guest access link and its access code of a BigBlueButton room.';
$string['bigbluebuttonbn:guestlink_set_password'] = 'Set/change the access code for a guest access link.';
...
$string['config_guestlink_editable_description'] = 'Guest access link feature can be edited when the room or conference is added or updated.';
...
$string['config_guestlink_moderatorapproval_editable_description'] = 'Moderator must approve guests feature can be edited when the room or conference is added or updated.';
$string['config_guestlink_moderatormessage_default'] = 'Moderator receives guest link in chat enabled by default';
$string['config_guestlink_moderatormessage_default_description'] = 'Moderator receives guest link in chat feature is enabled by default when a new room or conference is added.';
$string['config_guestlink_moderatormessage_editable'] = 'Moderator receives guest link in chat feature can be edited';
$string['config_guestlink_moderatormessage_editable_description'] = 'Moderator receives guest link in chat feature can be edited when the room or conference is added or updated.';
...
$string['mod_form_field_guestlink_help'] = 'You can use the guest access link to invite external guests who do not have a Moodle account to this conference room.';
$string['mod_form_field_guestlinkmoderatorapproval'] = 'Moderator must approve guests';
$string['mod_form_field_guestlinkmoderatorapproval_help'] = 'If you enable this function, external guests will have to wait until a moderator approves them before they can enter the conference room.';
$string['mod_form_field_guestlinkmoderatormessage'] = 'Moderators receive guest link in chat';
$string['mod_form_field_guestlinkmoderatormessage_help'] = 'If you enable this function, moderators will receive the guest link in the chat of the conference room. This way, they don\'t need to switch back to Moodle when they need to invite another participant.';
...
$string['view_guestlink_heading'] = 'Guest access link';
$string['view_guestlink_description'] = 'Use the guest access link to invite external guests who do not have a Moodle account to this conference room.';
$string['view_guestlink_link_icon_copy'] = 'Copy guest access link into clipboard';
$string['view_guestlink_link_label'] = 'Guest access link:';
$string['view_guestlink_moderatormessage'] = 'Share this guest access link to invite external guests who do not have a Moodle account to this conference room:<br />{$a}';
$string['view_guestlink_password_icon_copy'] = 'Copy room access code into clipboard';
$string['view_guestlink_password_icon_delete'] = 'Delete room access code';
$string['view_guestlink_password_icon_generate'] = 'Generate room access code';
$string['view_guestlink_password_label'] = 'Room access code:';
