...
$string['config_recording_hide_button_user_can_edit'] = 'Hide recording button can be edited';
$string['config_recording_hide_button_user_can_edit_description'] = 'If checked the interface includes an option for enable and disable the hide recording button feature.';
...
$string['mod_form_field_record_all_from_start'] = 'Record all from start';
$string['mod_form_field_record_hide_button'] = 'Hide recording button';
