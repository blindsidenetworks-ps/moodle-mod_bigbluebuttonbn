...
$string['activityoverview'] = 'Yaklaşan Canlı Dersleriniz var';
$string['bbbduetimeoverstartingtime'] = 'Bu etkinliğin bitiş zamanı başlangıç ​​zamanından fazla olmalıdır';
$string['bbbdurationwarning'] = 'Bu oturum için maksimum  %duration% dakikadır.';
$string['bbbrecordwarning'] = 'Bu oturum kaydedilebilir.';
...
$string['bigbluebuttonbn'] = 'Canlı Ders';
...
$string['index_heading_recording'] = 'Kayıt';
...
$string['mod_form_field_openingtime'] = 'Açılma Zamanı:';
$string['mod_form_field_closingtime'] = 'Kapanma Zamanı:';
$string['mod_form_field_intro'] = 'Açıklama';
...
$string['mod_form_field_duration'] = 'Süre(dk)';
...
$string['mod_form_field_welcome_default'] = '<br>Hoşgeldiniz : <b>%%CONFNAME%%</b>!<br><br>';
...
$string['mod_form_field_participant_bbb_role_moderator'] = 'Eğitmen';
...
$string['mod_form_field_notification_msg_created'] = 'oluşturuldu';
$string['mod_form_field_notification_msg_modified'] = 'düzenlendi';
...
$string['ends_at'] = 'Ends';
$string['calendarstarts'] = '{$a} Planlandı';
...
$string['view_login_moderator'] = 'Hocanın Dersi Açması Bekleniyor ...';
...
$string['view_recording_list_duration'] = 'Süre(dk)';
$string['view_recording_list_recording'] = 'Kayıt';
$string['view_recording_button_import'] = 'Kayıt bağlantılarını içe aktarma';
$string['view_recording_button_return'] = 'Geri';
$string['view_recording_format_notes'] = 'Notlar';
$string['view_recording_format_podcast'] = 'Podcast';
$string['view_recording_format_presentation'] = 'izle';
...
$string['view_message_moderator'] = 'Eğitmen';
$string['view_message_moderators'] = 'moderators';
$string['view_message_viewer'] = 'öğrenci';
$string['view_message_viewers'] = 'öğrenci';
$string['view_message_user'] = 'öğrenci';
$string['view_message_users'] = 'öğrenci';
...
$string['view_message_session_has_user'] = 'Şuan';
$string['view_message_session_has_users'] = 'Şuan';
$string['view_message_session_for'] = 'the session for';
$string['view_message_times'] = 'times';
$string['view_message_and'] = 've';

$string['view_message_room_closed'] = 'Canlı Yayın Kapalı.';
$string['view_message_room_ready'] = 'Canlı Yayın Hazır.';
$string['view_message_room_open'] = 'Canlı Yayın Açık.';
$string['view_message_conference_room_ready'] = 'Canlı Ders Başladı Oturuma Katıl Butonuna Tıklarak Girebilirsiniz.';
$string['view_message_conference_not_started'] = 'Canlı Ders Henüz Başlamadı.';
$string['view_message_conference_wait_for_moderator'] = 'Hocanın Dersi Başlatması Bekelniyor.';
$string['view_message_conference_in_progress'] = 'Canlı Ders Başladı.';
$string['view_message_conference_has_ended'] = 'Canlı Ders Tamamlanmıştır.Aşağıdaki kısımdan tekrarını izleyebilirsiniz.';
...
$string['view_conference_action_end'] = 'Dersi Bitir';
...
$string['view_recording_meeting'] = 'Ders Adı';
$string['view_recording_duration'] = 'Süre(dk)';
...
$string['view_recording_playback'] = 'Tekrar İzle';
$string['view_recording_preview'] = 'Preview';
$string['view_recording_preview_help'] = 'Resmin Üzerine Gelerek Resmi Büyütebilirsiniz.';
...
$string['email_body_notification_meeting_has_been'] = ' ';
$string['email_body_notification_meeting_details'] = 'Detay:';
$string['email_body_notification_meeting_title'] = 'Başlık';
$string['email_body_notification_meeting_description'] = 'Açıklama';
$string['email_body_notification_meeting_start_date'] = 'Başlama';
$string['email_body_notification_meeting_end_date'] = 'Bitiş';
$string['email_body_notification_meeting_by'] = 'Kim tarafından:';
$string['email_body_recording_ready_for'] = 'Recording for';
$string['email_body_recording_ready_is_ready'] = 'is ready';
$string['email_footer_sent_by'] = 'Bu Mesaj Otomatik Gönderildi.';
$string['email_footer_sent_from'] = 'Ders:';
